...
export class CourseComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.lessons$ = this.lessonsService.entities$.pipe(
      // emits pairs values, first will be from the lessons$, second will be from course$
    ...
    // ensure the loading indicator will only be affected in the next change detection
